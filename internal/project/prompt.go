...
func BuildSystemPrompt(opts BuildSystemPromptOptions) string {
	...
	b.WriteString("- A spawned subagent runs in the background; don't sleep/poll waiting for it. Its completion is pushed to you automatically the moment it finishes — do other work in the meantime, or just end your turn if there's none, rather than looping on subagent_status or a bash sleep.\n")
