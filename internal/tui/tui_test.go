...
func TestMatchSlash(t *testing.T) {
	cases := []struct {
		...
		{"/", []string{"/quit", "/clear", "/help", "/name", "/new", "/resume", "/sessions", "/search", "/compact", "/model", "/effort", "/classifier-model", "/providers", "/reload", "/cost", "/status", "/subscriptions", "/btw", "/openai-reset-usage", "/sandbox"}},
		{"/m", []string{"/model"}},
		{"/mo", []string{"/model"}},
		{"/mod", []string{"/model"}},
		{"/xyz", nil},
